...
public class ArraySKS {

    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        int jumlahMatkul;
        String[] mataKuliah = new String[20];
        int[] sks = new int[20];
        ...
        System.out.println("-------------------------------");
        input.nextLine();
        input(input, jumlahMatkul, mataKuliah, sks, nilai);

    }

    public static void input(Scanner input, int jumlahMatkul, String[] matkul, int[] sks, int[] nilai) {
        double ips, bobotNilai, nilaiAkhir, totalNilaiAkhir = 0, totalSks = 0;
        for (int i = 1; i <= jumlahMatkul; i++) {
            System.out.print("Mata Kuliah\t\t " + " : ");
            matkul[i] = input.nextLine();
            System.out.print("SKS Mata Kuliah " + matkul[i] + " : ");
            sks[i] = input.nextInt();
            System.out.print("Nilai Mata Kuliah " + matkul[i] + " : ");
            nilai[i] = input.nextInt();
            input.nextLine();
            bobotNilai = bobot(nilai[i]);
            nilaiAkhir = nilaiAkhir(sks[i], bobotNilai);
